...
export class EnviaProcessor {
  ...
  private getImpostoIPI(ipi: Ipi, modelo: string) {
    ...
    if (
      Number(ipi.vBC || 0) + Number(ipi.pIPI || 0) > 0 &&
  ...
  private getImpostoPIS(pis: Pis, modelo: string) {
    ...
    switch (pis.CST) {
      ...
      case "99":
        if (
          Number(pis.vBC || 0) + Number(pis.pPIS || 0) > 0 &&
  ...
  private getImpostoCOFINS(cofins: Cofins, modelo: string) {
    ...
    switch (cofins.CST) {
      ...
      case "99":
        if (
          Number(cofins.vBC || 0) + Number(cofins.pCOFINS || 0) > 0 &&
  ...
  private getInfoIntermed(info: InfoIntermediador | undefined) {
